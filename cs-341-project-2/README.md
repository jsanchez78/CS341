...
### Specific Guidelines for Project 2
First, please read section "Programming environment: Codio *or* the IDE of your choice" on Project 2 Specification.

To import test cases from Project 1 to Project 2 workspace:

(1) Export them as .zip file

(2) Unzip the exported .zip file on your local machine

(3) Drag and drop them into Codio environment for Project 2
